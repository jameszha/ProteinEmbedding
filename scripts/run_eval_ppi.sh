...
if [ -f $work_dir/'ppi_embeddings_binary.dat' ]; then echo "Binary embeddings found"
else python3 $src_dir/'get_ppi_embeddings.py' $data_dir/'protein_links.lst' $emb_dir/'binary_embeddings.lst' $work_dir/'ppi_embeddings_binary.dat'
fi

if [ -f $work_dir/'ppi_embeddings_onto2vec_parents.dat' ]; then echo "Onto2Vec Parent embeddings found"
else python3 $src_dir/'get_ppi_embeddings.py' $data_dir/'protein_links.lst' $emb_dir/'onto2vec_embeddings_parents.lst' $work_dir/'ppi_embeddings_onto2vec_parents.dat'
fi

if [ -f $work_dir/'ppi_embeddings_onto2vec_ancestors.dat' ]; then echo "Onto2Vec Ancestor embeddings found"
else python3 $src_dir/'get_ppi_embeddings.py' $data_dir/'protein_links.lst' $emb_dir/'onto2vec_embeddings_ancestors.lst' $work_dir/'ppi_embeddings_onto2vec_ancestors.dat'
fi

if [ -f $work_dir/'ppi_embeddings_onto2vec_none.dat' ]; then echo "Onto2Vec No-Ancestor embeddings found"
else python3 $src_dir/'get_ppi_embeddings.py' $data_dir/'protein_links.lst' $emb_dir/'onto2vec_embeddings_none.lst' $work_dir/'ppi_embeddings_onto2vec_none.dat'
fi

if [ -f $work_dir/'ppi_embeddings_onto2vec_sum.dat' ]; then echo "Onto2Vec Sum embeddings found"
else python3 $src_dir/'get_ppi_embeddings.py' $data_dir/'protein_links.lst' $emb_dir/'onto2vec_embeddings_sum.lst' $work_dir/'ppi_embeddings_onto2vec_sum.dat'
fi

if [ -f $work_dir/'ppi_embeddings_onto2vec_mean.dat' ]; then echo "Onto2Vec Mean embeddings found"
else python3 $src_dir/'get_ppi_embeddings.py' $data_dir/'protein_links.lst' $emb_dir/'onto2vec_embeddings_mean.lst' $work_dir/'ppi_embeddings_onto2vec_mean.dat'
fi

if [ -f $work_dir/'ppi_embeddings_dat_sum.dat' ]; then echo "Dat's Sum embeddings found"
